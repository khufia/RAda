...
do
    DIR=output/base2new/train_base/${dataset}/shots_${SHOTS}/${TRAINER}/${BS}_${LR}_${EP}/seed${SEED}


    LOG_FILE="${DIR}/log.txt"

    echo "Running $dataset"
    bash scripts/prompt_rada/base2new_train.sh $dataset ${SEED} ${BS} ${LR} ${EP} ${GPU}
...
for dataset in "${datasets[@]}"
do
    DIR=output/base2new/test_${SUB}/${dataset}/shots_${SHOTS}/${TRAINER}/${BS}_${LR}_${EP}/seed${SEED}
    LOG_FILE="${DIR}/log.txt"
    echo "Running $dataset"
    bash scripts/prompt_rada/base2new_test.sh $dataset ${SEED} ${BS} ${LR} ${EP} ${GPU}
