#!/bin/bash
# conda activate /home/zhiqiang.shen/anaconda/envs/maple
...
do
    ...
    bash scripts/ivl_rada/base2new_train_ivlp.sh $dataset ${SEED} ${BS} ${LR} ${EP} ${ALPHA} ${TEMP} ${GPU}
...
do
    ...
    LOG_FILE="${DIR}/log.txt"
    echo "Running $dataset"
    bash scripts/ivl_rada/base2new_test_ivlp.sh $dataset ${SEED} ${BS} ${LR} ${EP} ${ALPHA} ${TEMP} ${GPU}
