...
class Align(nn.Module):    
    ...
    def forward(self, image, label=None, training=False):
        ...
        self.inputs = self.processor(images=images ,text=self.prompts, return_tensors="pt").to("cuda")
        ...
        with torch.no_grad():
            ...
            text_outputs = self.text_encoder(
                ...
                token_type_ids=self.inputs['token_type_ids'],
                position_ids=None,
                head_mask=None,
                inputs_embeds=None,
        ...
        B, K, D = IT.shape
        scale = torch.tensor(1 / 0.07).log().exp().data  # in __init__
...
class ALIGN(TrainerX):
    ...
    def build_model(self):
        ...
        print("Building custom ALIGN")
        self.model = Align(cfg, classnames)
